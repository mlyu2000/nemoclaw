...
nemoclaw-0.2.10.tgz             Helm package of the chart (root level; top-level dir = nemoclaw)
nemoclaw/
├── 0.2.10/                     Version folder — the current Helm chart (v0.2.10)
│   ├── Chart.yaml
...
The importable artifact is **`nemoclaw-0.2.10.tgz` at the repo root**. Rebuild it after
changing the chart with `helm package nemoclaw/0.2.10 -d .`.
...
2. **Point it at this framework** — upload **`nemoclaw-0.2.10.tgz`** (the
